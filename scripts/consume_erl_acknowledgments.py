...
PRODUCER = "StegVerse-Labs/Administrations"
SOURCE = "producer_intake/acknowledgments/StegVerse-Labs__Administrations"
OUT = Path("receipts/executive-rhetoric-ledger-acknowledgments")
